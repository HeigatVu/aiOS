...
# 1. Load core OMZ library components (required for many OMZ plugins to work)
zinit snippet OMZ::lib/clipboard.zsh
zinit snippet OMZ::lib/history.zsh
zinit snippet OMZ::lib/directories.zsh

# 2. Load the git plugin immediately (so git aliases are ready instantly)
zinit snippet OMZP::git

# 3. Load the rest of the plugins asynchronously (Turbo mode)
zinit ice wait lucid
zinit for \
    OMZP::web-search \
    OMZP::copyfile \
